...
function colorMap(){
	for(i=0;i < dataset2.length; i++){
		if(dataset2[i].color1 == "SOC" || dataset2[i].color1 == "ECO" || dataset2[i].color1 == "RDG" || dataset2[i].color1 == "DVG"){
			svg2.select('[id='+'"'+dataset2[i].circo+'"'+']').style("fill", dicoNuances2[dataset2[i].color1])
		}
		else{
			if(dataset2[i].color2 == "SOC" || dataset2[i].color2 == "ECO" || dataset2[i].color2 == "RDG" || dataset2[i].color2 == "DVG"){
			svg2.select('[id='+'"'+dataset2[i].circo+'"'+']').style("fill", dicoNuances2[dataset2[i].color2])
			}
			else{
				if(dataset2[i].color3 == "SOC" || dataset2[i].color3 == "ECO" || dataset2[i].color3 == "RDG" || dataset2[i].color3 == "DVG"){
